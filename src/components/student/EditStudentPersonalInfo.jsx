    ...
    return (
      ...
      <label>University ID</label>
        <input type="text" className="form-control"  placeholder="Name"  
           required value={userData.studentId || ""} onChange={e=>{setUserData({...userData,hodid:e.target.value})}}
        />
      </div>
      <div className="mb-3 ">
                <label className="form-label">Current Year</label>
                <select className="form-select" 
          value={userData.year} onChange={e=>{setUserData({...userData,year:e.target.value})}} required>
